...
export function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      >
        <path d="M16.01 3.2c-7.06 0-12.8 5.74-12.8 12.8 0 2.26.59 4.47 1.72 6.41L3.1 29l6.76-1.78a12.7 12.7 0 0 0 6.15 1.57c7.06 0 12.8-5.74 12.8-12.8s-5.74-12.79-12.8-12.79Zm0 23.42c-1.93 0-3.82-.52-5.47-1.51l-.39-.23-4.01 1.05 1.07-3.91-.25-.4A10.55 10.55 0 0 1 5.38 16c0-5.86 4.77-10.63 10.63-10.63S26.64 10.14 26.64 16 21.87 26.62 16.01 26.62Zm5.83-7.96c-.32-.16-1.89-.93-2.18-1.04-.29-.11-.5-.16-.71.16-.21.32-.82 1.04-1.01 1.25-.19.21-.37.24-.69.08-.32-.16-1.35-.5-2.57-1.59-.95-.85-1.59-1.89-1.78-2.21-.19-.32-.02-.49.14-.65.14-.14.32-.37.48-.56.16-.19.21-.32.32-.53.11-.21.05-.4-.03-.56-.08-.16-.71-1.7-.97-2.33-.26-.61-.52-.53-.71-.54h-.61c-.21 0-.56.08-.85.4-.29.32-1.11 1.09-1.11 2.66s1.14 3.08 1.3 3.29c.16.21 2.24 3.42 5.43 4.79.76.33 1.35.52 1.81.67.76.24 1.45.21 2 .13.61-.09 1.89-.77 2.16-1.51.27-.74.27-1.38.19-1.51-.08-.13-.29-.21-.61-.37Z" />
      </svg>
    </a>
  );
}
