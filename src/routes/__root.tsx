...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "PuniTech" },
      { name: "keywords", content: "reparación celulares Cosquín, servicio técnico celulares, cambio de pantallas Cosquín, batería celular, Valle de Punilla, Córdoba" },
